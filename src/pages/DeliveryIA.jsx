        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0">
              ...
              <p className="text-xl mb-8">Transforme seu restaurante com a solução completa de atendimento e gestão de pedidos</p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              O Sistema de Delivery Inteligente da IA-X é uma plataforma completa que revoluciona as operações de delivery através do WhatsApp, o canal preferido pelos clientes brasileiros.
            </p>
          </div>
      ...
      <div className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Nosso Sistema de Delivery Inteligente oferece funcionalidades que vão muito além dos chatbots tradicionais.
            </p>
          </div>
      ...
      <div className="py-16 bg-gray-100" id="beneficios">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Nossa solução proporciona benefícios tangíveis e mensuráveis que transformam a operação de delivery dos restaurantes.
            </p>
          </div>
      ...
      <div className="bg-blue-900 py-16 text-center">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-blue-200 max-w-3xl mx-auto mb-8">
            Junte-se a centenas de restaurantes que já transformaram suas operações com nossa solução de IA.
          </p>
